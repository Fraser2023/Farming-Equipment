...
const Hiring = () => {
  return (
    ...
    <img src={compaction} alt="compaction" className='w-full md:h-full lg:h-full'/>
    </div>
      <div className="p-8 md:p-2 lg:p-8 w-full text-center bg-gray-100">
        ...
        <Link to="/learn-more">
          <button className='bg-[#F26E21] text-white p-4 my-8 rounded-md uppercase font-bold'>Learn More</button>
        </Link>
      </div>
    </div>
    </div>
